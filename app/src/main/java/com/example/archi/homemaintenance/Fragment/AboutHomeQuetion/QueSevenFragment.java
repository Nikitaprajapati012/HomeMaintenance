...
public class QueSevenFragment extends Fragment implements View.OnClickListener {

    @BindView(R.id.fragment_que_seven_txtoption1)
    TextView txtOption1;
    @BindView(R.id.fragment_que_seven_txtoption2)
    TextView txtOption2;
    @BindView(R.id.fragment_que_seven_txtquetion)
    TextView txtQuestion;
    public String Option1, Option2, Option3, Option4,Value;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);
        View view = inflater.inflate(R.layout.fragment_que_seven, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fragment_que_seven_txtoption1:
                editor.putString(questionNumber, Value + "," + Option1).commit();
                viewPager.setCurrentItem(viewPager.getCurrentItem() + 1);

                break;
            case R.id.fragment_que_seven_txtoption2:
